...
use crate::{ApiProtocol, Provider};
...
impl Provider {
    ...
    pub fn default_api(&self) -> Option<ApiProtocol> {
        match self {
    ...
    pub fn has_protocol_fallback(&self) -> bool {
    ...
    pub fn credentials_refreshable(&self) -> bool {
