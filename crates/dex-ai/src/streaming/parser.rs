use crate::wire::merge_chat_tool_call;
use crate::wire::response_call_index;
use crate::wire::response_tool_call;
...
pub fn delta_thought(delta: &StreamDelta) -> Option<&str> {
    delta
        .reasoning
        .as_ref()
...
pub struct AnthropicParser {
    pub blocks: HashMap<u64, AnthropicBlock>,
    pub tool_calls: Vec<LlmToolCall>,
