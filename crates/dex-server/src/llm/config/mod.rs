...
pub use crate::runtime::notice::warn_once;
pub use crate::workspace::{cached_parse, xdg_path, FileCache};
...
pub use super::thinking::{remember_thinking_effort, stored_thinking_effort};
#[cfg(test)]
pub use crate::workspace::unique_tmp_path;
...
#[cfg(test)]
pub use context_index::{build_ctx_map, write_ctx_index};
...
#[cfg_attr(not(feature = "tui"), allow(unused_imports))]
pub use cost::{cost_hint_for, model_hints_for};
pub use doctor::doctor;
pub use extension_model::{
...
pub use permission::permission_from_env;
pub use prompt_source::{resolve_cli_system_prompt, system_prompt_origin};
pub use provider::{
...
pub fn config_file_value() -> Option<serde_yaml::Value> {
    load_config_file()
}

pub fn load_config_file() -> Option<serde_yaml::Value> {
...
pub fn load_config_num(file: &Option<serde_yaml::Value>, key: &str) -> Option<u64> {
...
pub fn load_config_str(file: &Option<serde_yaml::Value>, key: &str) -> Option<String> {
    file.as_ref()
...
pub fn agent_wake_origin() -> (bool, &'static str) {
...
pub fn apply_verify_optin(config: &mut LlmConfig) {
...
/// test command.
pub fn detect_verify_command() -> Option<String> {
...
pub struct LlmConfig {
    ...
    pub provider_entries: BTreeMap<String, ProviderEntry>,
...
impl LlmConfig {
    ...
    pub fn refresh_thinking_effort(&mut self) {
    ...
    pub fn thinking_mismatch_warning(&self) -> Option<String> {
