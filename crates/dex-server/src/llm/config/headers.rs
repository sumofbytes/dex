...
pub fn parse_headers_str(raw: &str) -> BTreeMap<String, String> {
...
pub fn insert_extra_header(out: &mut BTreeMap<String, String>, name: &str, value: &str) {
    let name = name.trim();
...
pub fn apply_opencode_session_headers(config: &mut LlmConfig, session_id: &str) {
...
pub fn insert_parsed_headers(out: &mut BTreeMap<String, String>, raw: &str) {
...
pub fn config_headers_map(file: &Option<serde_yaml::Value>, key: &str) -> BTreeMap<String, String> {
...
pub fn load_config_headers(file: &Option<serde_yaml::Value>) -> BTreeMap<String, String> {
