...
pub fn provider_like_candidate(selection: &str, served: &[String]) -> Option<(String, String)> {
...
pub fn warn_provider_like_selection(
    selection: &str,
    provider_name: &str,
    served: &[String],
) -> bool {
...
pub fn catalog_env_vars(key: &str) -> Vec<String> {
...
pub fn reasoning_options_for(model: &str) -> Option<Vec<String>> {
...
pub fn validate_thinking_effort(model: &str, pick: &str) -> Result<String, Vec<String>> {
...
pub fn load_dex_models_cache() -> Option<Vec<String>> {
