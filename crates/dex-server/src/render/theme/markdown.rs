...
pub fn heading_text(t: &str) -> Option<&str> {
...
pub fn heading_level(t: &str) -> usize {
    t.len() - t.trim_start_matches('#').len()
}

pub fn is_heading(t: &str) -> bool {
...
pub fn blockquote_text(t: &str) -> Option<&str> {
...
pub fn is_ordered_item(t: &str) -> bool {
...
pub fn is_block_start(t: &str) -> bool {
    t.starts_with("```")
        || heading_text(t).is_some()
        || is_hr(t)
        || is_blockquote(t)
...
pub fn is_table_line(t: &str) -> bool {
    let t = t.trim();
...
pub fn is_table_start(lines: &[&str], i: usize) -> bool {
...
pub fn block_leaves_air(t: &str, is_table: bool) -> bool {
    is_table
        || is_heading(t)
        || is_hr(t)
        || is_blockquote(t)
...
pub fn is_continuation(prev: &str, prev_table: bool, curr: &str, curr_table: bool) -> bool {
...
pub fn is_continuation_lines(prev: &str, curr: &str) -> bool {
...
pub fn is_table_gap_line(t: &str) -> bool {
    let t = t.trim();
    if !is_table_line(t) {
        return false;
    }
...
pub fn needs_gap_before(prev_empty: bool, curr: &str) -> bool {
...
impl GapState {
    ...
    #[allow(dead_code)] // used by normalize_gaps (shared with client tests)
...
pub fn normalize_gaps(pending: &str, s: &str) -> String {
