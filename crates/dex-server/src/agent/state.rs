...
pub fn cache_fingerprint(name: &str, input: &str) -> String {
...
impl ToolState {
    ...
    /// bound without cloning live state. Awaits the JoinHandle so turn
    /// teardown (the sole caller, agent/loop.rs) cannot drop the write.
