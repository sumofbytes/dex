...
pub(super) const COMMANDS: &[SlashCommandSpec] = &[
    SlashCommandSpec {
        command: "/quit",
        usage: "/quit",
...
pub(super) fn parse(line: &str) -> SlashCommand<'_> {
...
pub(super) fn cmd_help(app: &mut App, remote: bool) {
